...
1. While connected to your Docker server, create a `docker` directory if you don't already have one.
  `mkdir docker`
2. Create a `gluetun` subdirectory within `docker`.
  `mkdir docker/gluetun`
