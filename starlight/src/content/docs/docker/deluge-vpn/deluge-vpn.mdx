...
This project sees a Deluge container route its traffic through a [Gluetun](../../docker/gluetun/gluetun.mdx) container's network. A more thorough write-up is available [here](https://www.jccpalmer.com/blog/deluge-docker-vpn).
...
This project requires the use of Gluetun, the details for which you can find in my [Gluetun documentation](../../docker/gluetun/gluetun).
